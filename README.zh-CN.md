...
![应用截图](screenshot/app-1920x1080-125.png)

## 🌟 与传统翻译工具的区别

- 更专注更简洁：输入与阅读体验优先，键入-翻译-复制更顺手
- 智能语言切换：中英自动判断目标语言，减少手动选择
- 视觉模型支持：先抽取图片文字，再一键翻译
- 内置语音朗读：输入与结果均可朗读，无需插件
- 隐私友好：本地保存配置，自带密钥接入，数据可控
...
<!-- 技术实现细节已移至 CLAUDE.md，README 主要面向普通用户 -->
